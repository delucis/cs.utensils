...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 165.0, 105.0, 23.0 ],
					"saved_object_attributes" : 					{
						"filename" : "cs.resize",
						"parameter_enable" : 0
					}
,
					"text" : "js cs.resize 195 15"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(signal) Input 1; (int) set selected input",
					"id" : "obj-3",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 135.0, 288.999999999999943, 23.0 ],
					"text" : "selector~ 6"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 15.0, 105.0, 120.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 195.0, 15.0 ],
					"rounded" : 4.0,
